      ...
      <xsl:otherwise>
        <xsl:if test="@resource">
          <tr>
            ...
            <td align="left" style="padding:3px;" nowrap="true"><input name="resourceview" type="button" value="?" onclick="javascript:window.open('{/project/@basedir}/{@resource}')"/></td>
          </tr>
        </xsl:if>
        <xsl:if test="@file">
          <tr>
            ...
            <td align="left" style="padding:3px;" nowrap="true"><input name="fileview" type="button" value="?" onclick="javascript:window.open('{/project/@basedir}/{@file}')"/></td>
          </tr>
        </xsl:if>
